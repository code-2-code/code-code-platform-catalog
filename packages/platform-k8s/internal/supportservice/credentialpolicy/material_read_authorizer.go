...
type MaterialReadAuthorizer struct {
	cliSupport    *clisupport.ManagementService
	vendorSupport *vendorsupport.ManagementService
}

func NewMaterialReadAuthorizer() (*MaterialReadAuthorizer, error) {
	...
	return &MaterialReadAuthorizer{
		cliSupport:    cliSupport,
		vendorSupport: vendorSupport,
	}, nil
}

func (a *MaterialReadAuthorizer) AuthorizeCredentialMaterialRead(
	ctx context.Context,
...
func (a *MaterialReadAuthorizer) allowedCredentialMaterialFields(
	ctx context.Context,
	policyRef *authv1.CredentialMaterialReadPolicyRef,
